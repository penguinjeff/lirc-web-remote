...
.button{width:<?php echo 30*$scale; ?>px;height:<?php echo 25*$scale; ?>px;border-style:solid;border-radius:<?php echo 5*$scale; ?>px;text-align:center;font-size:<?php echo 10*$scale; ?>px;margin-top: <?php echo 4*$scale; ?>px;
